...
const competitions = jsonFileService.getJsonFromFile(`${dataPath}competitions.json`);
...
const predictions = jsonFileService.getJsonFromFile(`${dataPath}predictions.json`);
...
export { getCompetitions, getSeasons, getTeams, getRounds, getMatches, getPredictions };
