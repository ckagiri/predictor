import { ComponentsOverrides, styled, useThemeProps, Theme } from "@mui/material";
import { ResourceItem, UiRecord, useCreatePath, useRecordContext, useResourceContext } from "../../frame";
...
export const EditButton = <RecordType extends UiRecord = any>(
    ...
    return (
        <StyledButton
            component={Link}
            to={createPath({ type: 'edit', resource: resource.path, id: record.slug || record.id })}
