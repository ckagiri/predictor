...
export const primeError = error =>
  ({ type: ActionTypes.PRIME_ERROR, error })

export const getCompetitions = () => ({ type: ActionTypes.GET_COMPETITIONS_START })

export const getCompetitionsComplete = competitions =>
  ({ type: ActionTypes.GET_COMPETITIONS_COMPLETE, payload: competitions })

export const selectCompetition = competitionSlug =>
  ({ type: ActionTypes.SELECT_COMPETITION, payload: competitionSlug })
...
export const getSeasonsComplete = (
  competitionSlug,
  seasons
) => ({ type: ActionTypes.GET_SEASONS_COMPLETE, payload: { competitionSlug, seasons } })

export const selectSeason = seasonId =>
  ({ type: ActionTypes.SELECT_SEASON, payload: seasonId })
...
export const selectGameRound = (seasonId, round) =>
  ({ type: ActionTypes.SELECT_GAME_ROUND, payload: { seasonId, round } })
