...
export const getSeasonsComplete = (competitionSlug: string, seasons: object[]) =>
  action(ActionTypes.GET_SEASONS_COMPLETE, { competitionSlug, seasons });
export const selectSeason = seasonId => action(ActionTypes.SELECT_SEASON, seasonId);
export const setSeasonData = (seasonId, { teams, matches, predictions, rounds }) =>
