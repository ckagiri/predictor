...
export const SELECT_SEASON = 'lp/Competitions/SELECT_SEASON';
export const SET_SEASON_DATA = 'lp/Competitions/SET_SEASON_DATA';
export const SELECT_GAME_ROUND = 'lp/Competitions/SELECT_GAME_ROUND';
export const LOAD_MATCHES_PAGE = 'lp/Competitions/LOAD_MATCHES_PAGE';
export const SET_CURRENT_PAGE = 'lp/Competitions/SET_CURRENT_PAGE';
